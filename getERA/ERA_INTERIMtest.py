...
def plotEIMovie(variable="temperature",start="2013-01-01", end="2013-01-04", resolution="1.0", latitudes=(2, 10), longitudes=(44, 48), level=1000):
    """
NAME
...
Code devised and written by bethan.perkins@assimila.eu
    ...
    dataFilepath = "/home/joel/src/topomap_v2/getERA/data"
    movieFilepath = "/home/joel/assimila/Videos"
...
plotEIMovie(variable="temperature",start="2013-01-01", end="2013-01-04", resolution="1.0", latitudes=(10, 11), longitudes=(48, 49), level=1000)
