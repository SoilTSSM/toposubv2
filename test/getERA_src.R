...
# convert grib ->netcdf uses climate data operators (cdo)
# https://code.zmaw.de/projects/cdo

# folder=workd setwd(folder) files=list.files(folder, '.grb')
# name=unlist(strsplit(files, '.grb'))


# for (i in name){ system(paste('cdo -f nc copy ', paste(i,'.grb',sep=''),' ',
# paste(i,'.nc', sep=''),sep='')) }



# vwind sfc fc 166.128 uwind sfc fc 165.128 2m dewpoint sfc fc 168.128 2m air
# temp sfc fc 167.128 ssrd sfc fc 169.128 strd sfc fc 175.128 totprecipi sfc fc
# 228.128 convective precip sfc fc 143.128 large scale precip sfc fc 142.128
# specific cloud liquid water 246.128 TOA rad in 212.128 surf pressure 134.128
# sealevel pressure 151.128 vertical integral mass of atmosphere = 53.162 total
# colum water fc 136.128 total column ozone fc 206.128 total column water vapour
# fc 137.128 Surface net solar radiation, clear sky fc 210.128 albedo an 174.128
# cloud press levels 248.128 longwave surface net clear 211.128 etc
