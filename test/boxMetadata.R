...
######################################################################################################## SETUP
######################################################################################################## ===========================================================================
######################################################################################################## wd<-getwd() root=paste(wd,'/',sep='')
######################################################################################################## parfile=paste(root,'/src/TopoAPP/parfile.r', sep='') source(parfile) #give nbox
######################################################################################################## and epath packages and functions nbox<-nboxSeq simindex=formatC(nbox,
######################################################################################################## width=5,flag='0') spath=paste(epath,'/result/B',simindex,sep='') #simulation
######################################################################################################## path

# setup=paste(root,'/src/TopoAPP/expSetup1.r', sep='') source(setup) #give tFile
# outRootmet
...
# find ele diff station/gidbox eraBoxEle<-getEraEle(dem=eraBoxEleDem,
# eraFile=tFile) # $masl
