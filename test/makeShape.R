# ==================================================================== SETUP
# ==================================================================== INFO reads
# comma separated files with header
...
shp <- makePointShapeGeneriRc(lon = dat[, loncol], lat = dat[, latcol], data = dat, 
...
# nb: do not use '~/' nb: overwrite does not work, if file exists function fails.
