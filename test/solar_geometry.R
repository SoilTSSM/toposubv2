solarGeom <- function(mf, dates, sdirm, tz)
{
    ...
    for (i in 1:sp)
    {
        ...
        # ===========================================================================================================================
        # normal vector - Calculates a unit vector normal to a surface defined by slope
        # inclination and slope orientation.
        # ==========================================================================================================================
        ...
        # ===============================================================================================
        # derive incident radiation on slope accounting for self shading and cast shadow
        # and solar geometry
        # ================================================================================================
