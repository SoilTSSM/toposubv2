...
# ==================================================================== PARAMETERS
# FIXED ==================================================================== 0.
# FIXED STUFF=soil_SANDYSILT (mean SILT + SAND) --> surface type vegetation
ThetaRes0 <- 0.056
ThetaSat0 <- 0.4305
...
# numbers corrospond to ../landcoverZones.txt [lori numbers] vegetation [0]
# debris [1] bedrock [2]
...
LateralHydrConductivity <- c(LateralHydrConductivity1, LateralHydrConductivity2, 
    LateralHydrConductivity0)
surfacedf <- data.frame(ThetaRes, ThetaSat, AlphaVanGenuchten, NVanGenuchten, NormalHydrConductivity, 
...
for (i in 1:npoints)
{
    ...
    # gt.exp.write(eroot_loc=paste(simRoot, 'sim',i, sep=''),eroot_sim,enumber=1,
    # fs=fs)
