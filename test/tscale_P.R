...
# POINTS
# =========================================================================== Get
# points meta data - loop through box directories

# make shapefile of points mf=read.table(metaFile, sep=',', header =T)
...
write.table(pSurf_lapse, paste(spath, "/pSurf_lapse.txt", sep = ""), row.names = F, 
    sep = ",")
